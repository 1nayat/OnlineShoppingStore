...
namespace OnlineShoppingStore.Repository
{
    public interface IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        int GetAllrecordCount();  // Return type changed from void to int
        ...
        void InactiveAndDeleteMarkByWhereCaluse(Expression<Func<Tbl_Entity, bool>> wherePredict, Action<Tbl_Entity> ForEachPredict);
        Tbl_Entity GetFirstorDeafultByParameter(Expression<Func<Tbl_Entity, bool>> wherePredict);
